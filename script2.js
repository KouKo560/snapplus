...
async function sendWebhook(payload) {
    console.log('sendWebhook payload', payload);
    try {
        ...
        console.log('sendWebhook response status', response.status, 'body', text);
...
if (step1Form) {
    step1Form.addEventListener('submit', async (e) => {
        ...
        showMessage('✅ Votre demande a été envoyée. Redirection vers le code en 30 secondes.', 'success');
        startCountdown(30);
    });
}
